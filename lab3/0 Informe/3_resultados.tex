...
Los datos fueron visualizados en tiempo real mediante una aplicación desarrollada en \textit{Python}, permitiendo verificar la respuesta dinámica del sistema.

Se observó una relación proporcional estable entre la diferencia de tensiones de los potenciómetros y la velocidad del motor. En la zona muerta (±10 unidades ADC) el motor permaneció detenido, y al aumentar la diferencia de referencia la velocidad respondió suavemente en ambos sentidos.  
...
El sistema respondió correctamente a los desplazamientos del joystick en ambos ejes, mostrando el movimiento del LED activo dentro de la matriz RGB de 8×8.  
...
\begin{figure}[H]
    ...
    \caption{Modo programación del sistema, con opción de alta y baja de tarjetas}
    \label{fig:rfid_prog}
\end{figure}
